 ...
 */ ?>
                  					...
                  					<li class="list-group-item b-1">
                                        ...
                                        class="pull-left" class=" m-r-10">
                                          <img src="http://stepsys.org/files/images/stu_pics/<?php echo $candid['pa_adm_no'] ?>_<?php echo $sbssessid; ?>.jpg" class="thumb-sm br-radius" alt="member">
                                        </a>
                                        <a  data-toggle="modal" 
                                        data-target="#<?php echo md5(md5(sha1($candid['pa_id']))); ?>">
  ...
  <div class="modal-dialog modal-full">
   ...
   <div class="modal-content">
	  ...
	  <div class="row">
		...
		<img style=" width:100%" align="center" class="img-responsive img-rounded" src="http://stepsys.org/files/images/stu_pics/'.$mrw['pa_adm_no'].'_'.$sbssessid.'.jpg" />
