...
<style>
body{
	background-image:url(IGJH3084JG/bg.png); margin:0;
...
<?php if(isset($_GET['errflag_li_notelig'])){
	$dispmsg = 'We are really sorry but E-Vote is only Eligeibal for class 8 and above'; 
echo '
...
setTimeout(function(){
 ...
 ';
  ...
  <form action="student-login-exec.php" method="get" class="form-1">
    ...
    <input id="input-294uhty289h-less-width" style="width:32%" class="input-294uhty289h1" maxlength="4" min="1995" type="text" name="year" placeholder="yyyy">
	<input id="input-294uhty289h-less-width" style="width:32%"  class="input-294uhty289h2" maxlength="2" min="01" type="text" name="month" placeholder="mm">
	<input id="input-294uhty289h-less-width" style="width:32%"  class="input-294uhty289h3" maxlength="2" min="01" type="text" name="day" placeholder="dd">
...
width: 100%;">
Website designed by Ayan Ahmad of Class 9-A. In case of any errors contact at anonymous.code.anonymous@gmail.com
