...
<li class="list-group-item b-0">
    <a href="#" class=" m-r-10">
      <img src="http://stepsys.org/files/images/stu_pics/<?php echo $data['pa_adm_no'] ?>_<?php echo $sbssessid; ?>.jpg" class="thumb-sm br-radius" alt="member">
    </a>
...
'<tr>
	...
	echo "http://sbs-school.org/sbsweb/files/staffimages/".$data['lum_image'];
						 ...
						 echo 'https://stepsys.org/files/images/stu_pics/'.$data['lum_image'].'_'.$sbssessid;
							}
						 echo'.jpg" /></td>
