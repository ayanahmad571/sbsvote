...
setTimeout(function(){
 ...
 ';
  ...
  <div class="login-card">
    ...
    <h1 style="font-size:25px; font-weight:bold;">Step By Step School<br>
 E-Vote</h1><br>
  
  <form action="master_action.php" method="post" class="form-1">
  	
    <input  required type="number" name="uid" style="width:100%;" id='replication_form_id' class="input-mn_23-c" maxlength="48" placeholder="Adm. No. / Emp. Id" autocomplete="off">
